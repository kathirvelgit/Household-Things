    ...
    >
      ...
      <div className="relative aspect-square rounded-[var(--radius-sm)] overflow-hidden bg-[var(--color-surface-container-low)] mb-[var(--spacing-space-md)]">
        ...
        <button
          ...
          className="absolute top-[var(--spacing-space-sm)] right-[var(--spacing-space-sm)] w-9 h-9 rounded-full bg-[rgba(250,249,246,0.9)] hover:bg-[var(--color-surface)] backdrop-blur-md flex items-center justify-center text-[var(--color-on-surface)] transition-colors shadow-sm"
        >
