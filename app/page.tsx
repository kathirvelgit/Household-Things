    ...
    <>
      ...
      <main className="w-full pt-[6.875rem] min-h-screen bg-[var(--color-surface)]">
        ...
        <section className="relative w-full overflow-hidden">
          <div className="max-w-7xl mx-auto px-[var(--spacing-margin)] md:px-[var(--spacing-margin-lg)] pt-[var(--spacing-space-md)] md:pt-[var(--spacing-space-xl)] pb-[var(--spacing-space-xl)]">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-[var(--spacing-gutter-lg)] items-center">

              {/* Hero copy */}
              <div className="lg:col-span-5 flex flex-col items-start z-10">
                <div className="inline-flex items-center gap-[var(--spacing-space-xs)] bg-[var(--color-surface-container-high)] px-[var(--spacing-space-md)] py-[var(--spacing-space-xs)] rounded-full mb-[var(--spacing-space-lg)] shadow-sm">
                  <span className="w-2 h-2 rounded-full bg-[var(--color-secondary)]" />
                  <span className="text-[var(--font-size-label-md)] font-semibold tracking-widest uppercase text-[var(--color-on-surface)]">
                    Release 04 / Autumn Equinox
                  </span>
                </div>

                <h1 className="text-[var(--font-size-display-lg-mobile)] md:text-[var(--font-size-display-lg)] font-semibold leading-tight tracking-[var(--letter-spacing-display-lg)] text-[var(--color-primary)] mb-[var(--spacing-space-md)]">
                  Designed for Serene Living
                </h1>

                <p className="text-[var(--font-size-body-lg)] leading-[var(--line-height-body-lg)] text-[var(--color-on-surface-variant)] mb-[var(--spacing-space-xl)] max-w-lg">
                ...
                <div className="flex flex-wrap items-center gap-[var(--spacing-space-md)] w-full sm:w-auto">
                  <Link
                    href="/products"
                    className="h-12 px-[var(--spacing-space-xl)] rounded-full bg-[var(--color-primary)] text-[var(--color-on-primary)] text-[var(--font-size-label-lg)] font-semibold tracking-[var(--letter-spacing-label-lg)] flex items-center gap-[var(--spacing-space-xs)] shadow-md hover:bg-[var(--color-primary-container)] transition-all"
                  >
                  ...
                  <Link
                    ...
                    className="h-12 px-[var(--spacing-space-lg)] rounded-full bg-[var(--color-surface-container-low)] text-[var(--color-on-surface)] hover:bg-[var(--color-surface-container-high)] text-[var(--font-size-label-lg)] font-semibold tracking-[var(--letter-spacing-label-lg)] flex items-center justify-center transition-colors"
                  >
                    Read Our Story
                  </Link>
                </div>
                ...
                {/* Stats strip */}
                <div className="mt-[var(--spacing-space-xl)] pt-[var(--spacing-space-lg)] w-full flex items-center gap-[var(--spacing-space-xl)]">
                  <div>
              ...
              <div className="lg:col-span-7 relative">
                <div className="relative w-full h-[32rem] sm:h-[38rem] rounded-[var(--radius-lg)] overflow-hidden shadow-2xl bg-[var(--color-surface-container)]">
                  <Image
                  ...
                  {/* Floating badge — top */}
                  <div className="absolute top-[var(--spacing-space-lg)] left-[var(--spacing-space-lg)] bg-[rgba(250,249,246,0.9)] backdrop-blur-md px-[var(--spacing-space-md)] py-[var(--spacing-space-sm)] rounded-full shadow-lg flex items-center gap-[var(--spacing-space-xs)]">
                    <span className="material-symbols-outlined text-[var(--color-secondary)] text-[1.1rem]">architecture</span>
                    <span className="text-[var(--font-size-label-sm)] font-semibold uppercase tracking-wider text-[var(--color-primary)]">
                      Handcrafted in Copenhagen
                    </span>
                  </div>

                  {/* Floating badge — bottom left */}
                  <div className="absolute bottom-[var(--spacing-space-lg)] left-[var(--spacing-space-lg)] bg-[rgba(250,249,246,0.9)] backdrop-blur-md px-[var(--spacing-space-md)] py-[var(--spacing-space-sm)] rounded-full shadow-lg flex items-center gap-[var(--spacing-space-xs)]">
                    <span className="material-symbols-outlined text-[var(--color-tertiary-fixed-dim)] text-[1.1rem]">eco</span>
                    <span className="text-[var(--font-size-label-sm)] font-semibold uppercase tracking-wider text-[var(--color-primary)]">
                  ...
                  <Link
                    href="/products/saltholm-low-table"
                    className="group absolute bottom-[var(--spacing-space-xl)] right-[var(--spacing-space-lg)] bg-[rgba(8,13,19,0.8)] hover:bg-[var(--color-primary)] text-[var(--color-on-primary)] backdrop-blur-lg px-[var(--spacing-space-lg)] py-[var(--spacing-space-sm)] rounded-full shadow-2xl flex items-center gap-[var(--spacing-space-sm)] transition-all hover:-translate-y-1"
                  >
        ...
        <section className="w-full bg-[var(--color-surface-container-low)] py-[var(--spacing-space-xl)]">
          <div className="max-w-7xl mx-auto px-[var(--spacing-margin)] md:px-[var(--spacing-margin-lg)]">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-[var(--spacing-space-xl)] gap-[var(--spacing-space-sm)]">
              <div>
                <span className="text-[var(--font-size-label-md)] font-semibold tracking-widest uppercase text-[var(--color-secondary)]">
                  Atelier Spectrum
                </span>
                <h2 className="text-[var(--font-size-headline-xl)] font-semibold leading-[var(--line-height-headline-xl)] tracking-[var(--letter-spacing-headline-xl)] text-[var(--color-primary)] mt-[var(--spacing-space-xs)]">
        ...
        <section className="w-full py-[var(--spacing-space-xl)]">
          <div className="max-w-7xl mx-auto px-[var(--spacing-margin)] md:px-[var(--spacing-margin-lg)]">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-[var(--spacing-space-xl)] gap-[var(--spacing-space-sm)]">
              <div>
                <span className="text-[var(--font-size-label-md)] font-semibold tracking-widest uppercase text-[var(--color-secondary)]">
                  Living Essentials
                </span>
        ...
        <section className="w-full bg-[var(--color-surface-container)] py-[var(--spacing-space-xl)]">
          <div className="max-w-7xl mx-auto px-[var(--spacing-margin)] md:px-[var(--spacing-margin-lg)]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[var(--spacing-gutter-lg)] items-center">
              <div className="relative h-80 lg:h-[30rem] rounded-[var(--radius-md)] overflow-hidden">
                <Image
              ...
              <div className="flex flex-col justify-center">
                ...
                <h2 className="text-[var(--font-size-headline-lg)] font-semibold leading-[var(--line-height-headline-lg)] tracking-[var(--letter-spacing-headline-lg)] text-[var(--color-primary)] mb-[var(--spacing-space-lg)]">
                  Craft is not a virtue. It is a practice.
                </h2>
                <p className="text-[var(--font-size-body-lg)] leading-[var(--line-height-body-lg)] text-[var(--color-on-surface-variant)] mb-[var(--spacing-space-md)]">
                ...
                <p className="text-[var(--font-size-body-lg)] leading-[var(--line-height-body-lg)] text-[var(--color-on-surface-variant)] mb-[var(--spacing-space-xl)]">
        ...
        <section className="w-full py-[var(--spacing-space-xl)]">
          <div className="max-w-7xl mx-auto px-[var(--spacing-margin)] md:px-[var(--spacing-margin-lg)]">
            ...
            <div className="text-center mt-[var(--spacing-space-xl)]">
              <Link
                href="/products"
                className="inline-flex items-center gap-[var(--spacing-space-xs)] h-12 px-[var(--spacing-space-xl)] rounded-full border border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-[var(--color-on-primary)] text-[var(--font-size-label-lg)] font-semibold tracking-[var(--letter-spacing-label-lg)] transition-all"
              >
